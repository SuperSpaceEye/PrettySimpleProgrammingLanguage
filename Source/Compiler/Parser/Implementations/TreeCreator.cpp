...
ASTCreationResult TreeCreator::create_ast(TranspilerResult &t_result, bool debug) {
...
void TreeCreator::process_unk_word(int end_num, int do_not_recurse, std::pair<Token, std::pair<int, int>> &token,
...
void
TreeCreator::create_variable_call_node(std::shared_ptr<BaseAction> &node, const std::pair<Token, std::pair<int, int>> &token,
                                       int id) {
...
void TreeCreator::create_user_defined_fn_call_node(int end_num, int do_not_recurse,
...
void
TreeCreator::create_builtin_fn_call_node(const std::vector<std::pair<Token, std::pair<int, int>>> &tokens, int end_num,
...
void TreeCreator::create_str_const_node(const std::pair<Token, std::pair<int, int>> &token,
                                        const std::vector<std::pair<Token, std::pair<int, int>>> &tokens,
                                        std::shared_ptr<BaseAction> &node, int &i,
...
void TreeCreator::create_num_const_node(const std::pair<Token, std::pair<int, int>> &token,
                                        const std::vector<std::pair<Token, std::pair<int, int>>> &tokens,
                                        std::shared_ptr<BaseAction> &node, int &i,
                                        std::shared_ptr<BaseAction> &temp_root) {
...
void
TreeCreator::create_while_node(int end_num, int do_not_recurse, const std::pair<Token, std::pair<int, int>> &token,
...
void TreeCreator::create_if_statement_node(int end_num, int if_statement_nesting, int do_not_recurse,
...
void TreeCreator::create_var_decl_node(const int &logic_indentation, IdRegister &reg,
                                       const std::pair<Token, std::pair<int, int>> &token,
                                       const std::vector<std::pair<Token, std::pair<int, int>>> &tokens,
                                       std::shared_ptr<BaseAction> &node, int &i,
                                       std::shared_ptr<BaseAction> &temp_root) {
...
void
TreeCreator::create_fn_decl_node(IdRegister &reg, const std::vector<std::pair<Token, std::pair<int, int>>> &tokens,
...
void TreeCreator::get_arguments(int end_num, const std::vector<std::pair<Token, std::pair<int, int>>> &tokens, int &logic_indentation, bool &function_declaration,
...
void
TreeCreator::recursive_create_ast(const std::vector<std::pair<Token, std::pair<int, int>>> &tokens, int &logic_indentation,
                                  bool &function_declaration, ASTCreationResult &to_return, IdRegister &reg,
...
int TreeCreator::get_id(const std::vector<std::pair<Token, std::pair<int, int>>> &tokens, int &i) {
    return (int)tokens[++i].first;
}

VariableType TreeCreator::convert_token_type(const std::pair<Token, std::pair<int, int>> &token) {
    switch (token.first) {
...
void TreeCreator::check_token_is_valid_argument(const std::pair<Token, std::pair<int, int>> &token, int &i) {
    switch (token.first) {
        case Token::INT:
        case Token::UINT:
        case Token::FLOAT:
